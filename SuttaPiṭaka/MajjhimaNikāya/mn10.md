...
Here’s a table in Markdown format listing the locations where suttas from the Majjhima Nikāya were delivered, in descending order of the number of suttas given at each location.
